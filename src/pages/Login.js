    ...
    return ( 
        <main className="w-11/12 my-0 mx-auto">
            <section>
                ...
                <p className="text-white text-center mb-10">If you are new here, please create an <Link to="/register" className="underline">account</Link></p>
            </section>        
            <form onSubmit={handleLogin} className="w-96 my-0 mx-auto max-md:w-4/5">
                <div className="mb-6">
                    <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your email</label>
                    <input ref={email} type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="e.g minenhledev@gmail.com" required autoComplete="off" />
                </div>
                <div className="mb-6">
